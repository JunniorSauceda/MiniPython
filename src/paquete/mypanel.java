...
public class mypanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
    ...
    private static mypanel figselec;
    ...
    public static mypanel getFigselec() {
        return figselec;
    }

    public static void setFigselec(mypanel figselec) {
        mypanel.figselec = figselec;
    }
